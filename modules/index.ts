...
Quill.register(Image as any, true); // 允许图片的样式保存在Delta中
Quill.register(ListItem as any, true); // 允许列表的起始值和类型保存在Delta中
Quill.register(DividerBlot as any, true); // 允许普通分隔线和样式保存在Delta中
Quill.register(
  {
